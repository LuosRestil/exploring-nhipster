...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'nesthipster';
    ...
    'jhipster.mail.from' = 'nesthipster@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'nesthipster API';
    'jhipster.swagger.description' = 'nesthipster API documentation';
    ...
    'eureka.instance.appname' = 'nesthipster';
    'eureka.instance.instanceId' = 'nesthipster:${random.value}';
